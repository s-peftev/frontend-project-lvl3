...
test('parsing valid rss', async () => {
	...
	const expectedFeed = { id: 'feed_1', title: 'Deutsche Welle: DW.COM News', description: 'Deutsche Welle: DW.COM News' };
	const expectedPosts = [
		{
			id: 'post_2',
			title: 'У школы в Кабуле прогремели минимум три взрыва',
			description: 'У школы в западном районе Кабула, где проживают шииты, произошли три взрыва, среди учеников есть раненые.',
			link: 'https://www.dw.com/ru/у-школы-в-кабуле-прогремели-минимум-три-взрыва/a-61509255?maca=rus-rss-ru-news-4383-xml-mrss',
			feedID: 'feed_1',
		},
		{
			id: 'post_3',
			title: 'Вице-премьер Украины: Гуманитарных коридоров не будет третий день подряд',
			description: 'Россия продолжает военное вторжение в Украину, начатое 24 февраля по приказу Владимира Путина. DW следит за событиями 19 апреля.',
